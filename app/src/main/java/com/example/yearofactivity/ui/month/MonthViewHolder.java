...
public class MonthViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
    ...
    private final com.example.yearofactivity.ui.month.MonthAdapter.OnItemListener onItemListener;

    public MonthViewHolder(@NonNull View itemView, com.example.yearofactivity.ui.month.MonthAdapter.OnItemListener onItemListener) {
        super(itemView);
